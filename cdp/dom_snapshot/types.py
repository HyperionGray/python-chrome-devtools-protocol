...
class DOMNode:
    ...
    def from_json(cls, json: T_JSON_DICT) -> 'DOMNode':
        text_value = json['textValue'] if 'textValue' in json else None
        input_value = json['inputValue'] if 'inputValue' in json else None
        input_checked = json['inputChecked'] if 'inputChecked' in json else None
        option_selected = json['optionSelected'] if 'optionSelected' in json else None
        child_node_indexes = [i for i in json['childNodeIndexes']] if 'childNodeIndexes' in json else None
        attributes = [NameValue.from_json(i) for i in json['attributes']] if 'attributes' in json else None
        pseudo_element_indexes = [i for i in json['pseudoElementIndexes']] if 'pseudoElementIndexes' in json else None
        layout_node_index = json['layoutNodeIndex'] if 'layoutNodeIndex' in json else None
        document_url = json['documentURL'] if 'documentURL' in json else None
        base_url = json['baseURL'] if 'baseURL' in json else None
        content_language = json['contentLanguage'] if 'contentLanguage' in json else None
        document_encoding = json['documentEncoding'] if 'documentEncoding' in json else None
        ...
        content_document_index = json['contentDocumentIndex'] if 'contentDocumentIndex' in json else None
        ...
        is_clickable = json['isClickable'] if 'isClickable' in json else None
        event_listeners = [dom_debugger.EventListener.from_json(i) for i in json['eventListeners']] if 'eventListeners' in json else None
        current_source_url = json['currentSourceURL'] if 'currentSourceURL' in json else None
        origin_url = json['originURL'] if 'originURL' in json else None
        scroll_offset_x = json['scrollOffsetX'] if 'scrollOffsetX' in json else None
        scroll_offset_y = json['scrollOffsetY'] if 'scrollOffsetY' in json else None
        return cls(
            ...
            pseudo_element_indexes=pseudo_element_indexes,
            layout_node_index=layout_node_index,
            ...
            system_id=system_id,
            frame_id=frame_id,
            content_document_index=content_document_index,
...
class InlineTextBox:
    ...
    def from_json(cls, json: T_JSON_DICT) -> 'InlineTextBox':
        return cls(
            ...
            start_character_index=json['startCharacterIndex'],
            num_characters=json['numCharacters'],
        )
...
class LayoutTreeNode:
    ...
    def from_json(cls, json: T_JSON_DICT) -> 'LayoutTreeNode':
        layout_text = json['layoutText'] if 'layoutText' in json else None
        inline_text_nodes = [InlineTextBox.from_json(i) for i in json['inlineTextNodes']] if 'inlineTextNodes' in json else None
        style_index = json['styleIndex'] if 'styleIndex' in json else None
        paint_order = json['paintOrder'] if 'paintOrder' in json else None
        is_stacking_context = json['isStackingContext'] if 'isStackingContext' in json else None
        return cls(
            dom_node_index=json['domNodeIndex'],
            bounding_box=dom.Rect.from_json(json['boundingBox']),
            layout_text=layout_text,
            inline_text_nodes=inline_text_nodes,
            style_index=style_index,
            paint_order=paint_order,
            is_stacking_context=is_stacking_context,
        )
...
class RareStringData:
    ...
    def to_json(self) -> T_JSON_DICT:
        json: T_JSON_DICT = {
            'index': [i for i in self.index],
            'value': [i.to_json() for i in self.value],
        }
        return json
...
class NodeTreeSnapshot:
    ...
    def from_json(cls, json: T_JSON_DICT) -> 'NodeTreeSnapshot':
        parent_index = [i for i in json['parentIndex']] if 'parentIndex' in json else None
        node_type = [i for i in json['nodeType']] if 'nodeType' in json else None
...
class LayoutTreeSnapshot:
    ...
    def to_json(self) -> T_JSON_DICT:
        json: T_JSON_DICT = {
            'nodeIndex': [i for i in self.node_index],
            'styles': [i.to_json() for i in self.styles],
            'bounds': [i.to_json() for i in self.bounds],
            'text': [i.to_json() for i in self.text],
            'stackingContexts': self.stacking_contexts.to_json(),
        }
        return json
    ...
    def from_json(cls, json: T_JSON_DICT) -> 'LayoutTreeSnapshot':
        return cls(
            node_index=[i for i in json['nodeIndex']],
...
class TextBoxSnapshot:
    ...
    def to_json(self) -> T_JSON_DICT:
        json: T_JSON_DICT = {
            'layoutIndex': [i for i in self.layout_index],
            'bounds': [i.to_json() for i in self.bounds],
            'start': [i for i in self.start],
            'length': [i for i in self.length],
        }
        return json
    ...
    def from_json(cls, json: T_JSON_DICT) -> 'TextBoxSnapshot':
        return cls(
            layout_index=[i for i in json['layoutIndex']],
            bounds=[Rectangle.from_json(i) for i in json['bounds']],
            start=[i for i in json['start']],
            length=[i for i in json['length']],
        )
...
class DocumentSnapshot:
    ...
    def to_json(self) -> T_JSON_DICT:
        json: T_JSON_DICT = {
            'documentURL': self.document_url.to_json(),
            'baseURL': self.base_url.to_json(),
            'contentLanguage': self.content_language.to_json(),
            'encodingName': self.encoding_name.to_json(),
            'publicId': self.public_id.to_json(),
            'systemId': self.system_id.to_json(),
            'frameId': self.frame_id.to_json(),
            'nodes': self.nodes.to_json(),
            'layout': self.layout.to_json(),
            'textBoxes': self.text_boxes.to_json(),
        }
        if self.scroll_offset_x is not None:
            json['scrollOffsetX'] = self.scroll_offset_x
        if self.scroll_offset_y is not None:
