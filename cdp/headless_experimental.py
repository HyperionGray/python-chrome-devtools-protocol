...
class ScreenshotParams:
    ...
    def from_json(cls, json: T_JSON_DICT) -> 'ScreenshotParams':
        return cls(
            format=str(json['format']) if 'format' in json else None,
...
def begin_frame(
    ...
    :param frame_time_ticks: Timestamp of this BeginFrame in Renderer TimeTicks (milliseconds of uptime). If not set, the current time will be used.
    ...
    :param no_display_updates: Whether updates should not be committed and drawn onto the display. False by default. If true, only side effects of the BeginFrame will be run, such as layout and animations, but any visual updates may not be visible on the display or in screenshots.
