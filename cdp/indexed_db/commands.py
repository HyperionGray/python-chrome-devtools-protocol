...
class IndexedDB:
    @staticmethod
    def clear_object_store(security_origin: str, database_name: str, object_store_name: str) -> None:
        '''
    ...
    @staticmethod
    def delete_database(security_origin: str, database_name: str) -> None:
        '''
        Deletes a database.
    ...
    @staticmethod
    def delete_object_store_entries(security_origin: str, database_name: str, object_store_name: str, key_range: KeyRange) -> None:
        '''
    ...
    @staticmethod
    def request_data(security_origin: str, database_name: str, object_store_name: str, index_name: str, skip_count: int, page_size: int, key_range: KeyRange) -> dict:
        '''
        ...
        return {
                ...
                'hasMore': bool.from_response(response['hasMore']),
            }

    @staticmethod
    def get_metadata(security_origin: str, database_name: str, object_store_name: str) -> dict:
        '''
        ...
        response = yield cmd_dict
        return {
                'entriesCount': float.from_response(response['entriesCount']),
                'keyGeneratorValue': float.from_response(response['keyGeneratorValue']),
            }

    @staticmethod
    def request_database(security_origin: str, database_name: str) -> DatabaseWithObjectStores:
        '''
    ...
    @staticmethod
    def request_database_names(security_origin: str) -> typing.List:
        '''
