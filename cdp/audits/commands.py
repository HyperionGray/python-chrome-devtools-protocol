...
class Audits:
    @staticmethod
    def get_encoded_response(request_id: network.RequestId, encoding: str, quality: float, size_only: bool) -> dict:
        '''
        ...
        return {
                ...
                'originalSize': int.from_response(response['originalSize']),
                'encodedSize': int.from_response(response['encodedSize']),
            }
